...
def check_file_convertibility(file_path):
    ...
    Returns a tuple (result, log_message) where result is True if the file is convertible, False otherwise,
    and log_message contains error or success message.
    """
    try:
        ...
        log_message = f'Problem found in "{file_path}":\n{error_output}.\nFile will not be processed.\n'
    ...
    for file_path in file_paths:
        try:
            ...
            if result.returncode != 0:
                ...
                log_message = f'Error converting "{file_path}":\n{error_output}'
